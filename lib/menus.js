...
const ALL = {
  ...
  UTIL: ["ping","status","runtime","speed","prefix","totalcomandos","sticker","jid","lidme","lidgp","qr <t>","calc <c>","horas","data","wiki <t>","reverse <t>","encurtar <url>","ip <ip>","github <user>","binario <t>","morse <t>","base64 <t>","debase64 <t>","uuid","random <a> <b>","senha <n>"],
  ...
  ACOES: ["abraco @","beijo @","tapa @","soco @","mata @","casar @","divorciar","ship @ @","reza @","chorar","rir","dancar","dormir","amizade @","odio @","iq @"],
  ...
  DONO: ["on","off","typing on/off","join <link>","sairgrupo","autosair <tempo>","broadcast <m>","setbotname <n>","modo <publico|privado>","resetdb / limpezahd","addsaldo @ <v>","remsaldo @ <v>","addxp @ <v>","banuser @","desbanuser @","setvip @ <d>","unvip @","setpremium @ <d>","unpremium @","listgrupos","reiniciar / restart","exec <js>","addcomando <n> <r>","delcomando <n>"],
};
